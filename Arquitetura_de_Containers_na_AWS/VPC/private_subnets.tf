...
#route table para subnets privadas = > conjunto de regras de roteamento
...
#associando a  routa  ao internet gateway
...
#criar associações a uma subnet para tabela de rotas
